            ...
            <nav className="flex items-center justify-between container   px-4 md:px-0">
                ...
                <div className="flex items-center gap-4 md:gap-5">
                    <div className="relative">
                        ...
                        <p className="absolute bg-white md:size-5 size-4 rounded-full -top-0.5 -right-1 md:-right-2 text-sm md:text-md text-(--primary-color) flex items-center justify-center">0</p>
