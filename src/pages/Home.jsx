            ...
            <div className='bg-[url(/images/herobg.png)] bg-cover bg-center aspect-2/1 py-15 '>
                <div className='container px-4 md:px-0 py-30'>
                    ...
                    <div className='mt-10 flex items-center gap-8'>
                        <Link to='/booktable' className='px-5 py-3 bg-(--primary-color-dark) hover:bg-(--primary-color) transition duration-300 text-white rounded-md'>Book a Table</Link>
                        <Link to='/menu' className='text-white border-2 border-white px-8 py-2.5 hover:border-(--bg-dark) hover:bg-(--bg-dark) transition duration-300 rounded-md'>View Menu</Link>
                    </div>
                </div>
